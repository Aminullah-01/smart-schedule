...
function Authenticated({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "app-shell min-h-screen text-slate-900", children: [
    /* @__PURE__ */ jsxs("nav", { className: "sticky top-0 z-30 border-b border-slate-200/70 bg-white/85 backdrop-blur", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex h-16 justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
          /* @__PURE__ */ jsxs(Link, { href: "/", className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(ApplicationLogo, { className: "h-9 w-9 object-contain" }),
            /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxs("h1", { className: "text-xl font-bold tracking-tight", children: [
              /* @__PURE__ */ jsx("span", { className: "text-slate-900", children: "Smart" }),
              /* @__PURE__ */ jsx("span", { className: "text-teal-600", children: "Schedule" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "hidden space-x-2 sm:flex", children: [
            /* @__PURE__ */ jsx(
              NavLink,
              {
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: (showingNavigationDropdown ? "block" : "hidden") + " border-t border-slate-200 bg-white/95 sm:hidden",
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-200 pb-2 pt-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "px-4", children: [
                /* @__PURE__ */ jsx("div", { className: "text-base font-semibold text-slate-800", children: user.name }),
                /* @__PURE__ */ jsx("div", { className: "text-sm text-slate-500", children: user.email })
              ] }),
    ...
    header && /* @__PURE__ */ jsx("header", { className: "fade-up border-b border-slate-200/70 bg-white/70", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl px-4 py-7 sm:px-6 lg:px-8", children: header }) }),
